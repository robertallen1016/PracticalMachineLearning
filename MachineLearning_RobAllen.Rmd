...
```
##Conclusion  
This test shows that the Random Forest model is more accurante than the GBM model and RPART model.  The random forest model has a testing error (1 - Standard Error) of `r 100 - mean_rf`, while the GBM model as a testing error of `r 1 - mean_gbm` and the rpart model having an error of `r 100 - mean_rpart`.
